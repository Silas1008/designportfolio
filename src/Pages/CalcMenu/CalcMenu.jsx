...
const CalcMenu = () => {
  return (
    ...
    <div className="understanding" style={{paddingTop: '60px'}}>
   ...
   <div className="left">
   <p>We also decided to add 
   the icon that indicates 
   that the data is not yet 
   complete</p>
   <img src={left} alt=""/>
   </div>

   <div className="right">
   <p>And since many users have access to
   other accessible recipes, any changes
   they make would be recorded in in the
   activity column</p>
   <img src={right} alt=""/>
   </div>
   </div>
   ...
   <p>The changes we implemented were designed to make it easier for users to make updates more efficiently, with less typing, fewer clicks, and more information. This is important as users will also need to update changes across other recipes</p>
    ...
    <div className="up">
    <div className="container" style={{ backgroundColor: '#C5EAFB' }}>
    ...
    <div className="container" style={{ backgroundColor: '#FAE6D8' }}>
    ...
    <div className="down">
    <div className="container" style={{ backgroundColor: '#B8B0D8' }}>
    ...
    <div className="container" style={{ backgroundColor: '#88A4D6' }}>
